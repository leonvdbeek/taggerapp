...
export default function TagMap(props) {
  ...
  return (
    <LoadingOverlay style={{ height: "100%", position: "fixed" }} active={props.loading} spinner text={<Typography>Loading data..</Typography>}>
      <GoogleMapProvider>
        <MapBox
          ...
          style={{
            height: "100vh",
            width: "100vw",
            minHeight: "-webkit-fill-available", position: "fixed"
          }}
          opts={{
            center: props.cent,
            zoom: 6,
